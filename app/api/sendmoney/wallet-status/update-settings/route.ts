...
// NOT part of this route — the modal doesn't edit it. Mirrors
// app/api/wallet-status/update-settings/route.ts exactly, targeting Send
// Money's own separated column block instead.
