                ...
                <div className="relative">
                  {!loading && (
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-medium border rounded-lg hover:bg-white transition-colors ${anyFilterActive ? 'border-[color:var(--product-accent)]/40 text-[color:var(--product-accent)]' : 'border-border text-foreground'}`}
                    >
                      <Filter size={14} />
                      Filter
                    </button>
