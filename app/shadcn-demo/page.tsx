...
// Full word-for-word recreation of app/balance-overview/page.tsx, restyled
// with shadcn components (Card/Table/Badge/Button/Skeleton) instead of the
// hand-rolled Design System v2 markup. Same data, same computations, same
// labels/copy as the real page — duplicated here rather than shared, same
// convention the rest of this codebase already uses for page-local logic.
// Scratch/demo route only — not linked in the sidebar, does not touch
// app/balance-overview/page.tsx.
...
export default function ShadcnBalanceOverviewDemo() {
      ...
      <header className="sticky top-0 z-30 border-b bg-background/95 py-0 px-4 backdrop-blur-sm md:px-8">
        <div className="flex h-12 items-center justify-between gap-2">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <h1 className="truncate text-[13px] font-semibold tracking-[-0.01em] text-foreground">Balance Overview — shadcn demo</h1>
          </div>
          <div className="flex shrink-0 items-center gap-2">
            <Button variant="outline" size="icon" aria-label="Send to Telegram" title="Demo only — send disabled" disabled className="h-8 w-8">
              <Send size={13} />
            </Button>
            <ThemeToggle />
