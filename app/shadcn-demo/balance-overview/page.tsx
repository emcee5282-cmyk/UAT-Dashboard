...
// app/sendmoney/topup/page.tsx, and app/balance-overview/page.tsx — this
// table's per-brand Top Up/Settlement totals must resolve brand identically
// to those tabs. Includes 'SH' (Sharing), a brand Cashout's own roster
// doesn't have.
