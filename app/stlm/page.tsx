...
// Brand: #F8FAFC bg, 1px #E5E7EB border, 999px radius, 28px tall, 0/10px
// padding, 12px/600 — reads as a proper identifying tag. Fixed height (not
// vertical padding) keeps every badge the same size regardless of glyph
// ascenders/descenders in the brand code.
  ...
  return (
    ...
    >
      <SettlementHeader
        ...
        onRefresh={fetchData}
      />
      <SettlementSummary items={kpiItems} isScrolled={tableScrolled} />
